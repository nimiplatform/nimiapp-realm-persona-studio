...
const APP_EXECUTABLE_NAME = "nimiapp-realm-persona-studio-shell";
const APP_PRODUCT_NAME = "Realm Persona Studio";
...
try {
  ...
  const packagePaths = await packager({
    ...
    arch: NATIVE_ARCH,
    appBundleId: "ai.nimi.apps.nimi.realm-persona-studio",
